...
Another patient shortly thereafter was found to have severe renal impairment associated with their type 2 diabetes. The renal function tests had been performed as part of the diabetes assessment. Each result was only 10-15\% than the previous. Occasionally one result showed a small rise in eGFR before the downward progression resumed. The patient was cared for by several different clinicians, but the common factor was the focus was on the diabetes and the renal disease was a side issue to the clinical focsus of attention.\\
