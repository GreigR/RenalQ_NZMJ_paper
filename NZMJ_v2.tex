...
We used a semi-structured sensitive interview instrument to allow primary care staff to both reflect on their experiences with RenalQ and enabling them to provide in-depth feedback. In the "responsive interview" paradigm, the emphasis is on the fact that the interviewer and interviewee are both people and that they form a relationship during the interview \citep{rubin2011qualitative}. Additionally, the research design can remain flexible throughout the project meaning that if new information, or a new area of interest, is uncovered then the current interview, and subsequent interviews, can probe this area. \\
